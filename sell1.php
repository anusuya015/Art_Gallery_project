...
$username = "root";
$password = " *8DDB62AE133C93750650642B7B5D0AF21644B0A2";
$dbname = "ip";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["artwork_image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO Artworks (name, email, artwork_title, artwork_description, artwork_image) VALUES ('$name', '$email', '$artwork_title', '$artwork_description', '$target_file')";
